...
<Callout emoji="✅">
To download the dataset, please visit our [PhysioNet page](https://physionet.org/content/globem).
</Callout>

<Callout emoji="💡">
To learn more about the data collection study, please visit our [UW-EXP study page](https://make4all.org/uwexperience/).
</Callout>

## Dataset Introduction

GLOBEM datasets contain the first released multi-year mobile and wearable sensing datasets that include four years of data collection studies (2018-2021), 
conducted at University of Washington (led by the [UW-EXP Study Team](/team)).
...
We also collected additional information about participants, including the smartphone platform they installed the data collection app, 
